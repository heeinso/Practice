					...
					<div className="row">
						<div className="col-sm-12 col-md-10 col-lg-8 col-xl-7 mr-auto ml-auto">
							<p className="mt-3 mb-4 text-center">
								If you want to support password based sign in, two factor
								authentication or another sign in method, define a signin()
								function in <strong>next-auth.functions.js</strong>.
							</p>
							...
							<p className="text-italic text-muted text-center small">
								For this to work, you will need enable the signin() function in{' '}
